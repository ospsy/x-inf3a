function new_segment(input_dir, starti, endi)
...
for i=starti:endi,    
    ...
    cnt = 0;
    for l=1:length(L)
        cmd=sprintf('!/home/hongwenk/workspace/multisegment/Release/multisegment 0.5 %d 50 %s %s', L(l), ppm, out); %
    ...
    disp('Clustering');    
    img_dir=pathstr;
    segmentClustering(name, tmp_dir, seg_dir, img_dir);
end
end
