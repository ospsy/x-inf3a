...
/*----------------- Read 1-line ----------------
     ...
     �ᤁE�  0  : Reach EOF, can't find any charactor
...
*/
{
	...
	for(;;){
		...
		for ( i = 0 ; i < len ; i++ ){  /*Remove left side space� */
			if ( char_buf[i] != ' ' ) break;
		}
...
int setfile::find_word(char keyword[])
/*
	Input     keyword
	Output   1 : Find header  0 no Header
*/
...
*/
{
	...
	count = 1;
		...
		/* ʸ������������E*/
		/* ʸ����ν���E�Ȥߤʤ���Τϡ�EOF�����ԡ�;�����򡢥��� */

	for(;;){

		if ( count >= maxlen-1 ){   /* ����ʸ����򥪡��С� */
			while(1){               /* �ɤ�Ǥ���E����ʸ����� */
				input  = fp.get();  /* �����åפ���E*/
				string = (char)input;
				if ( input == EOF ) break;
...
/* ʸ����α�¦�ζ����E�E���E   ���Ե��椬����E�E�Ϥ���E⽁E�����E

    1999.1.20   ���Ե��椬����E�E�ϡ�����E⽁E���
                ����E���E�������̲�āE
*/
...
#  �����Ȥ�񤱤�E
1012                  # ����E�������΁E
1.23456789012345   # �¿���΁E ����EϷ�������������EϤ�
1.23456789012345   # �¿���΁E ����E�����פ���
abcdefghi          # ʸ������ɤ߹���
zxc                # ʸ������ɤ߹���
c++ string         # ʸ������ɤ߹���
------
