...
public class TenseurCourbure {
	...
	public void computeEigenvectors()
	{
		...
		double y1 = - (a - vp1)/b ; // le vecteur est (x,y) avec x = 1. Il reste � normaliser
	...
	// Distance � un tenseur de courbure (distance euclidienne via les vp, 
	// a ceci pr�s qu'on peut les inverser)
