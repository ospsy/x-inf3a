...
public class Courbure {
	
	/* Calcul du vecteur normal ˆ une face. Sa norme est le double de l'aire de la face */
	public static Vector_3 vecteurNormal (Face f)
	{
		Halfedge he = f.getEdge() ;
	...
	// Calcul du vecteur normal ˆ un point
	public static Vector_3 vecteurNormal (Vertex v)
	{
		Halfedge he = v.getHalfedge(), premier = he ;
		boolean debut = true ;
