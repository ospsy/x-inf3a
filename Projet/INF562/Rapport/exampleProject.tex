...
\\\\
Avec le calcul de la courbure de Gauss, nous obtenons différentes signatures, représentées sur la \textbf{figure ~\ref{tore_gaussian}}.  \\
...
En utilisant l'algorithme de Taubin, on obtient également un jeu de différentes signatures (\textbf{figure ~\ref{tore_taubin}}).
